...
@section('content')
    ...
    <script>
        ...
        <button onclick="window.location.href = '/edit/${element.className}/${element.id}#${element.className}'">Edit</button>
        <button onclick="remove('${element.className}', '${element.id}')">Delete</button>
    </div>`
                navFixed = false
                nav.style.display = 'flex'
            }
